...
Route::prefix('admin/')->group(function () {
    ...
    Route::delete('administrator/{id}', [AdminController::class, 'destroy'])->name('admin.delete');

    //Akun
    Route::get('akun', [AdminController::class, 'edit']);
    Route::put('akun', [AdminController::class, 'update']);
    Route::put('akun', [AdminController::class, 'newPass']);
