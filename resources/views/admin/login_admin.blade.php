                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body">
                      ...
                      <form class="row g-3" action="/admin/login_admin" method="POST">
                        @csrf
    
                        <div class="col-12">
                          <label for="yourUsername" class="form-label">Username</label>
                          <div class="input-group">
                            <input type="text" name="username" class="form-control" placeholder="username" id="yourUsername">
                        ...
                        <div class="col-12">
                          ...
                          <input type="password" name="passwword" class="form-control" placeholder="password" id="yourPassword">
